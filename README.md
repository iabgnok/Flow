...
**本部分目录** 
· [3.0 实施总原则](#30-实施总原则) 
· [3.1 阶段 1–4（实施记录）](#31-阶段-14实施记录) 
· [3.2 阶段 5（规划与状态）](#32-阶段-5规划与状态) 
· [3.3 测试与质量保障](#33-测试与质量保障) 
· [3.4 Prompt 调优专项](#34-prompt-调优专项) 
· [3.5 典型失败案例](#35-典型失败案例) 
· [经验总结](#lessons)
